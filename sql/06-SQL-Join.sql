...
UPDATE `products` SET `brand_id` = 4 WHERE `brand` = 'HTC';
UPDATE `products` SET `brand_id` = 5 WHERE `brand` = 'Huawei';
UPDATE `products` SET `brand_id` = 6 WHERE `brand` = 'LG';
UPDATE `products` SET `brand_id` = 7 WHERE `brand` = 'Samsung';
UPDATE `products` SET `brand_id` = 8 WHERE `brand` = 'Sony';
